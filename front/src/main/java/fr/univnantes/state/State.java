...
class State {
	...
	void playPlusFourCard(Game game, EffectCard card, Color color) throws StateException {throw new StateException();}
	...
	List<ACard> contest(Game game, IRemoteClient contestedClient) throws StateException {throw new StateException();} // You think that the +4 was wrongfully played so you contest the move
	List<ACard> doNotContest(Game game, IRemoteClient contestedClient) throws StateException {throw new StateException();} // The +4 may have been right so you do nothing
	...
	List<ACard> loseContest(Game game) throws StateException {throw new StateException();} // Cards to draw after loosing the contest (6)
